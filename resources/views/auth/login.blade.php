...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('Logo Tk Teratai.png') }}">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-6 sm:mb-8">
                <div class="flex justify-center mb-4">
                    <img src="{{ asset('Logo Tk Teratai.png') }}" alt="Logo TK Teratai" class="w-24 h-24 sm:w-28 sm:h-28 object-contain drop-shadow-md">
                </div>
                ...
                <form action="{{ route('login.store') }}" method="POST" class="space-y-4 sm:space-y-6">
                    ...
                    <div class="flex justify-between items-center pt-2">
                        <a href="{{ route('forgot.password') }}"
                            class="text-red-600 text-xs sm:text-sm underline hover:text-red-800 transition">
                            Lupa password?
                        </a>
                    </div>
