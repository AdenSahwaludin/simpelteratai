...
@section('content')
    <div class="p-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Data Orang Tua</h1>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('admin.orangtua.index') }}" method="GET" class="mb-6">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($orangTua as $item)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $item->siswa_count }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex gap-2">
                                        <a href="{{ route('admin.orangtua.edit', $item->id_orang_tua) }}"
                                            class="text-blue-600 hover:text-blue-900">Edit</a>
                                        <form action="{{ route('admin.orangtua.destroy', $item->id_orang_tua) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-4 text-center text-gray-500">Tidak ada data orang tua</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
