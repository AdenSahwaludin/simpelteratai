...
@section('dashboard-title', 'Tambah Mata Pelajaran')
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <nav class="mb-6">
            <ol class="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <li><a href="{{ route('admin.mata-pelajaran.index') }}" class="hover:text-blue-600">Data Mata
                        Pelajaran</a></li>
                <li><i class="fas fa-chevron-right text-xs"></i></li>
                <li class="text-gray-900 font-medium">Tambah Mata Pelajaran</li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 max-w-2xl">
            <div class="mb-6">
                ...
                <p class="text-gray-600 text-sm mt-1">Isi form di bawah untuk menambahkan mata pelajaran</p>
            </div>
            ...
            <form action="{{ route('admin.mata-pelajaran.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="nama_mapel" name="nama_mapel" value="{{ old('nama_mapel') }}" required
