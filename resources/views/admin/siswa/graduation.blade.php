...
@section('content')
    <div class="max-w-5xl mx-auto">
        <div class="mb-4">
            <a href="{{ route('admin.siswa.index') }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 transition font-medium">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
            <div class="mb-8 border-b border-gray-100 pb-6">
                <h2 class="text-xl font-bold text-gray-800 flex items-center">
                    <i class="fas fa-graduation-cap text-purple-600 mr-3 text-2xl"></i>
            ...
            <form action="{{ route('admin.siswa.graduation') }}" method="GET" class="mb-8">
                <div class="flex flex-col sm:flex-row gap-4">
                    <div class="flex-1">
                        ...
                        <select name="source_kelas" id="source_kelas"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-100 focus:border-transparent transition shadow-sm"
            ...
            @if ($sourceKelasId)
                ...
                <form action="{{ route('admin.siswa.process-graduation') }}" method="POST" id="formKelulusan">
                    @csrf
                    
                    <div class="mb-6 flex justify-between items-center bg-purple-50 p-4 rounded-lg border border-purple-500">
                        <div>
                            <h3 class="font-bold text-purple-900">Daftar Siswa Aktif</h3>
                            <p class="text-sm text-purple-700">Pilih siswa yang akan diproses kelulusannya</p>
                        </div>
                        <div class="text-right">
                            <span class="text-sm font-semibold text-purple-800 bg-white px-3 py-1 rounded-full shadow-sm">
                    ...
                    @else
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <th class="px-6 py-4 text-left">
                                            <div class="flex items-center">
                                                <input type="checkbox" id="selectAll"
                                                    class="w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500 cursor-pointer transition">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($siswaList as $siswa)
                                        <tr class="hover:bg-purple-50 transition cursor-pointer row-siswa" onclick="toggleCheckbox('{{ $siswa->id_siswa }}')">
                                            <td class="px-6 py-4" onclick="event.stopPropagation();">
                                                <input type="checkbox" name="siswa_ids[]" value="{{ $siswa->id_siswa }}"
                                                    id="checkbox_{{ $siswa->id_siswa }}"
                                                    class="siswa-checkbox w-4 h-4 text-purple-600 border-gray-300 rounded focus:ring-purple-500 cursor-pointer transition">
                                            </td>
                        ...
                        <div class="flex justify-end pt-6 border-t border-gray-100">
                            <button type="button" onclick="confirmSubmit()"
                                class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2.5 rounded-lg transition font-medium shadow flex items-center text-sm">
        ...
        <script>
            ...
            function updateRowStyle(checkbox) {
                ...
                if (checkbox.checked) {
                    ...
                    row.classList.remove('hover:bg-purple-50');
                } else {
