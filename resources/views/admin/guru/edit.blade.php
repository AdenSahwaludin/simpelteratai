        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('admin.guru.update', $guru->id_guru) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="px-4 py-2 bg-gray-100 rounded-lg text-gray-700">{{ $guru->id_guru }}</div>
                </div>
                ...
                <div class="mb-6">
                    <label for="no_telpon" class="block text-sm font-medium text-gray-700 mb-2">No. Telepon <span
                            class="text-red-500">*</span></label>
                    <input type="text" id="no_telpon" name="no_telpon" value="{{ old('no_telpon', $guru->no_telpon) }}"
