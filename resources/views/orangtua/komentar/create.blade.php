    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <nav class="mb-6">
            <ol class="flex items-center space-x-2 text-sm text-gray-600">
                ...
                <li><i class="fas fa-chevron-right text-xs"></i></li>
                <li class="text-gray-900 font-medium">Tambah Komentar</li>
            </ol>
        </nav>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 max-w-2xl">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Tambah Komentar Baru</h1>
                <p class="text-gray-600 text-sm mt-1">Berikan masukan atau pertanyaan kepada sekolah</p>
            </div>

            <form action="{{ route('orangtua.komentar.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea id="komentar" name="komentar" rows="8" required
                        ...
                        placeholder="Tulis komentar, masukan, atau pertanyaan Anda di sini...">{{ old('komentar') }}</textarea>
                    @error('komentar')
